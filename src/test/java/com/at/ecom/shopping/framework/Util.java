...
public class Util {
	...
	/**
	 * Function to get the Run Time Data Path
	 * 
	 * @return The Test Data Logs Path in String
	 */
	public static String getTargetCaptureLogsPath() {

		File targetPath = new File(
				Util.getAbsolutePath() + Util.getFileSeparator() + target + Util.getFileSeparator() + "RunTimeDataLogs");
